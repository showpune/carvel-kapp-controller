...
type PackageSpec struct {
	...
	// TODO: if we do it this way , the "versions.VersionSelectionSemver" will include pre-releases, and also we should check whether it works with vendor-speicific k8s versions
